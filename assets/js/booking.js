...
(function () {
  ...
  function locale() { return window.KL_LANG === "en" ? "en-US" : "es-ES"; }
  ...
  function summary() {
    ...
    var W = window.KL_LANG === "en" ? ["adults", "children"] : ["adultos", "niños"];
  ...
  function rateCal() {
    ...
    var dows = window.KL_LANG === "en" ? ["M", "T", "W", "T", "F", "S", "S"] : ["L", "M", "M", "J", "V", "S", "D"];
  ...
  function panel5() {
    var code = "KL-SB-" + Math.random().toString(36).slice(2, 7).toUpperCase();
