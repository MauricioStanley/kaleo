...
(function () {
  "use strict";
  var WA = "50376057844"; // WhatsApp del hotel, formato internacional para wa.me
  var WA_MSG = encodeURIComponent(
    "Hola, quisiera información sobre una reserva en Kaleo Hotel Boutique."
  );
  ...
  if (!document.querySelector(".announce")) {
    ...
    a.innerHTML =
      '<span>Reserva directa &middot; desayuno en Nava, sin comisiones y cancelaci&oacute;n flexible.</span> ' +
    ...
    a.querySelector(".announce__x").addEventListener("click", function () {
      ...
      try { localStorage.setItem("kl_announce", "off"); } catch (e) {}
    });
    try { if (localStorage.getItem("kl_announce") === "off") document.body.classList.add("announce-off"); } catch (e) {}
  }

  /* La barra fija de reserva que aparecía al hacer scroll se retiró:
     tapaba la cabecera (con la navegación y el botón Reservar, ya
  ...
  '<div class="wrap">' +
    '<div class="footer-grid">' +
      '<div>' +
        '<a class="brand" href="index.html">' +
          '<span class="brand__mark" aria-hidden="true"><svg viewBox="0 0 32 40"><path d="M16 38V20" stroke="#8fae8f" stroke-width="2.4" stroke-linecap="round"/><path d="M16 22c0-6 4-10 10-11 0 6-4 10-10 11Z" fill="#8fae8f"/><path d="M16 26c0-6-4-10-10-11 0 6 4 10 10 11Z" fill="#476a4b"/></svg></span>' +
          '<span class="brand__word"><b>Kaleo</b><span>Hotel Boutique</span></span>' +
        '</a>' +
        '<p class="muted" style="margin-top:16px;max-width:34ch">Avenida La Capilla #353, Colonia San Benito, San Salvador, El Salvador.</p>' +
      ...
      '<div>' +
        ...
        '<ul>' +
          ...
          '<li><a href="nava.html">Nava y cafetería</a></li>' +
      ...
      '<div>' +
        ...
        '<ul>' +
          ...
          '<li>Recepción: <a href="tel:+50321248941">+503 2124 8941</a></li>' +
          '<li>WhatsApp: <a href="https://wa.me/' + WA + '">+503 7605 7844</a></li>' +
          '<li><a href="mailto:reservaciones@hotelkaleo.com">reservaciones@hotelkaleo.com</a></li>' +
        '</ul>' +
      '</div>' +
      '<div>' +
        '<h4>Boletín</h4>' +
    ...
    '<div class="footer-bottom">' +
      '<p>© <span data-year>2026</span> Kaleo Hotel Boutique · San Salvador. Sitio de demostración.</p>' +
